...
const { Component, computed, isPresent, observer, run } = Ember;
...
export default Component.extend({
  ...
  _labelUpdater: observer('value', function() {
    run.scheduleOnce('afterRender', this, function() {
      // Need to instruct materialize to update text fields when values are programatically changed
