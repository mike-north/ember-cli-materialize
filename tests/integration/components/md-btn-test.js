...
test('large and flat classes are applied appropriately', function(assert) {
    ...
    assert.equal(this.$('.md-btn').attr('class').replace(/ember-view/g, '').trim(), 'md-btn btn btn-large waves-effect waves-light');
    this.set('isLarge', false);
    assert.equal(this.$('.md-btn').attr('class').replace(/ember-view/g, '').trim(), 'md-btn btn waves-effect waves-light');
    this.set('isFlat', true);
    assert.equal(this.$('.md-btn').attr('class').replace(/ember-view/g, '').trim(), 'md-btn btn-flat waves-effect waves-light');
    this.set('isLarge', true);
    assert.equal(this.$('.md-btn').attr('class').replace(/ember-view/g, '').trim(), 'md-btn btn-flat btn-large waves-effect waves-light');
});
